...
out.println(getPoolContents(ac,mynode, "rg", "DataSource","erpa1301"));
out.println(getPoolContents(ac,mynode, "rg", "DataSource","erpa1302"));
out.println(getPoolContents(ac,mynode, "rg", "DataSource","erpa1303"));
out.println(getPoolContents(ac,mynode, "rg", "DataSource","erpa1304"));
out.println(getPoolContents(ac,mynode, "rg", "DataSource","erpb1301"));
out.println(getPoolContents(ac,mynode, "rg", "DataSource","erpb1302"));
out.println(getPoolContents(ac,mynode, "rg", "DataSource","erpb1303"));
out.println(getPoolContents(ac,mynode, "rg", "DataSource","erpb1304"));
    	  }catch(Exception e){
