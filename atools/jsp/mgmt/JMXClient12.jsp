...
out.println(getPoolContents(ac,mynode, "rg", "DataSource","erpa1201"));
out.println(getPoolContents(ac,mynode, "rg", "DataSource","erpa1202"));
out.println(getPoolContents(ac,mynode, "rg", "DataSource","erpa1203"));
out.println(getPoolContents(ac,mynode, "rg", "DataSource","erpa1204"));
out.println(getPoolContents(ac,mynode, "rg", "DataSource","erpb1201"));
out.println(getPoolContents(ac,mynode, "rg", "DataSource","erpb1202"));
out.println(getPoolContents(ac,mynode, "rg", "DataSource","erpb1203"));
out.println(getPoolContents(ac,mynode, "rg", "DataSource","erpb1204"));
    	  }catch(Exception e){
