...
<%@ page buffer="64kb"
         ...
         isErrorPage="true"
%>
<%@ page import="com.ibm.websphere.servlet.error.ServletErrorReport" %>
...
<%
    ...
    ServletErrorReport errReport = (ServletErrorReport) request.getAttribute("ErrorReport");
    ...
    <script>
        ...
        function contentMsg(obj) {
            obj.value = "Time: <%= dateFormat() %>\r\n" +
                    "Serv: <%= dsCom.companyId %> <%= request.getServerName() %> <%= serverName %> \r\n" +
...
<table width="100%" border="1" cellspacing="0" cellpadding="0" class="msg">
    <tr>
        <td align="center"><b><%= serverName %> 无任何错误可报告</b></td>
    </tr>
</table>
<%
        return;
    ...
    if (errReport != null) {
        ...
        localR = errReport.getTargetServletName();
        code = errReport.getErrorCode();
        messageR = errReport.toString();
        stackTraceR = errReport.getStackTraceAsString();
    }
        ...
        <td colspan="3">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" background="/erp/images/dz/error_top_bg.gif">
                <tr>
                    ...
                    <td width="69%"><strong><font color="#FFFFFF">WAS <%= serverName %>: <%= code %>
                    </font></strong></td>
                    <td width="3%">
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="5" background="/erp/images/dz/error_bg.gif">
                <tr>
                    ...
                    <form method="post" action="/erp/dw/jsp/dwjj0091.jsp" target="_blank"
                        ...
                        <td>
                            <input type=submit value="将错误通报资讯人员">
...
<div class=msg id="Layer1"
     style="position:absolute; z-index:1; overflow: auto; width: 100%; border: 0px outset; visibility: ; height: 100%">
    <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td colspan="3">
