...
<%@ page import="com.icsc.dpms.de.dejc329" %>
<%@ page import="com.icsc.dpms.de.dejc330" %>
<%@ page import="com.icsc.dpms.ds.dsjccom" %>
<%@ page import="java.io.File" %>

<%
    dsjccom dsCom = new dsjccom();
    dsCom.setDsjccom("icsc", "dzjjwork", "ICSC01");
    dsCom.db.userId = "a";
    dsCom.db.passwd = "a";
    dsCom.db.url = "a";
    dsCom.ver = "1";
    ...
    if (button == null) {
        ...
        dejc329 de329 = new dejc329(fileString, dsCom);
